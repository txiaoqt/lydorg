-- Migration: 20260918040000_yorp_section35_metric_b_hardening.sql
-- Description: Enforce Metric B calculation based on first formal registration submission per organization
--              using MIN(document_submissions.submitted_at) for registration scope, new_organization.
