-- Migration: 20260919030000_exclude_draft_budget_requests_from_admin_snapshot.sql
-- Description: Update get_admin_portal_snapshot to strictly exclude draft budget requests
--              and their associated files from the Admin portal snapshot.
--              Draft budget requests are strictly organization-side in-progress items
--              and must not enter the Admin review workflow until submitted.
