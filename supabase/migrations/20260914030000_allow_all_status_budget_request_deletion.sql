-- Migration: 20260914030000_allow_all_status_budget_request_deletion.sql
-- Description: Update admin_bulk_delete_budget_requests to allow full administrative deletion
--              across all lifecycle statuses (including budget_released and completed),
--              removing the protected-status exception and enforcing complete dependency cleanup.
