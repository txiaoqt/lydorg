...
export const PolicyContent = ({
  ...
  for (let index = 0; index < lines.length; index += 1) {
      ...
      blocks.push(
        <h2
          ...
          className={isRedesign
            ? "font-segoe scroll-mt-[130px] border-b border-public-border-default pb-2 sm:pb-[10px] pt-3 sm:pt-4 first:pt-0 text-sm sm:text-public-fs-subtitle-sm font-bold sm:font-semibold leading-snug sm:leading-[120%] tracking-[-0.02em] text-public-text-brand"
    ...
    if (line.startsWith("- ")) {
      ...
      index -= 1;
      blocks.push(
        <ul key={`ul-${index}`} className="space-y-1.5 sm:space-y-2 pl-4 sm:pl-5 text-xs sm:text-[15px] leading-relaxed sm:leading-[1.65] text-foreground marker:text-primary">
    ...
    blocks.push(
      <p
        ...
        className={isMetadata
          ...
          : isRedesign
            ? "font-segoe text-xs sm:text-public-fs-subheading-sm font-normal leading-relaxed sm:leading-[160%] text-public-text-neutral-default text-left"
